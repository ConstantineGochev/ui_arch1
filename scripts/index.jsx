...
import { base_button, special_button , mobile_special_button} from './elements/button/index.jsx'
...
function get_mobile_special_items() {
   let mobile_special_items  = []

   special_menu_items.forEach(item => mobile_special_items.push(mobile_special_button(item)))
   return mobile_special_items;
}
...
function _init() {
   ...
   new FullScreenNav(get_regular_menu_items(), get_special_menu_items(), get_mobile_special_items())
